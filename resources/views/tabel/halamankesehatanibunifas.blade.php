                ...
                <!-- ============================================================== -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12 mb-4">
                            <h5 class="card-title text-center">Kesehatan Ibu Nifas</h5>  
                        </div> 
                        ...
                        <form class="app-search-form col-8 mt-3" method="GET"> 
                            <div class="input-group" style="width: 300px;">
                                <input type="text" placeholder="Cari Data..." name="search" class="form-control search-input" value="{{ $search }}" id="search" onkeyup="window.history.pushState({}, '', window.location.href='/kesehatanibunifas/?search='+this.value+'&status_nifas=<?=$status_nifas;?>')">
                        ...
                        <!--<div class="col-2">-->
                        <!--    <button type="button" class="btn btn-outline-dark rounded-pill fw-bold text-white" style="background-color: #EE66A6;margin-left: 75px;" onclick="window.location='{{ url('tambahkesehatanibunifas') }}'" style="margin-left: 75px; background-color: #EE66A6;">Tambah</button>-->
                        <!--</div>-->
                        </div>
                            ...
                            <table class="table table-bordered table-hover text-center">
                                <thead class="text-center" style="background-color: #4DA8DA;">
                                    <tr>
                                        ...
                                        <!--<th class="col-1">Jumlah Bersalin</th>-->
                                    ...
                                    <tr>
                                        ...
                                        <td>  <div class="row">
                                            <div class="col-6 text-center">
                                                <button onclick="window.location='{{ url('kesehatanibunifas/'.$row->id.'?status_nifas='.$status_nifas) }}'" type="button" class="btn btn-success btn-md" title="Detail">
