                ...
                <!-- ============================================================== -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12 mb-4">
                            <h5 class="card-title text-center">Daftar Akun Ibu</h5>  
                        </div> 
                        ...
                        <div class="col-2">
                            <button type="button"  onclick="window.location='{{ url('tambahakunibu') }}'"  class="btn btn-outline-dark rounded-pill fw-bold text-white" style="background-color: #4DA8DA; margin-left:75px;">Tambah</button>
                        </div>
                        </div>
                       ...
                       <div class="card-body">
                        <div class="table-responsive bg-white">
                            <table class="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                    @php
                                    $nomor = 1 + (($akunibu->currentPage()-1)* $akunibu->perPage());
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>  <div class="row">
                                            ...
                                            <div class="col-6 text-center">
                                             <button onclick="window.location='{{ url('daftarakunibu/'.$row->id) }}'" type="button" class="btn btn-md btn-warning" title="Edit Data">
                                                  <i class="fa fa-edit"></i>
                                             </button>
                                            </div>
                                            <div class="col-6 text-center">
                                             <form onsubmit="return deleteData('{{ $row->nama }}')" action="{{ url('daftarakunibu/'.$row->id) }}" method="POST"> 
                                              @csrf
                                              @method('DELETE')
                            ...
                            {!! $akunibu->appends(Request::except('page'))->render() !!}
                        </div>
                       </div>
