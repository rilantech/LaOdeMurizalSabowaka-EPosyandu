                ...
                <div class="card" style="background-color: #F2F2F2;">
                    <div class="card-body">
                        ...
                        <div class="col-12 mb-4">
                            <h5 class="card-title text-center">Data Orang Tua & Anak</h5>  
                        </div> 
                        ...
                        <div class="col-2">
                            <button type="button" class="btn btn-outline-dark rounded-pill fw-bold text-white" onclick="window.location='{{ url('tambahdataorangtuadananak') }}'" style="background-color:  #4DA8DA;margin-left:75px;"">Tambah</button>
                        </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>  <div class="row" style="margin-left:6px;">
                                            <div class="col-3 text-center">
                                                <button onclick="window.location='{{ url('dataorangtuadananak/'.$row->id) }}'" type="button" class="btn btn-success btn-md" title="Detail">
                                          ...
                                          <div class="col-3 text-center">
                                            <a href="{{ url('cetakdataorangtuadananak/'.$row->id) }}" class="btn btn-primary btn-md" title="Cetak" target="_blank">
                                                <i><img
