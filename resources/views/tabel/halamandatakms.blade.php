                ...
                <!-- ============================================================== -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12 mb-4">
                            <h5 class="card-title text-center">Data KMS</h5>  
                        </div> 
                        ...
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-dark rounded-pill fw-bold text-white" style="background-color: #4DA8DA;margin-left: 250px;" onclick="window.location='{{ url('/tambahdatakms') }}';" style="margin-left: 75px; background-color: #EE66A6;">Tambah</button>
                        </div>
                        </div>
                       ...
                       <div class="card-body">
                        <div class="table-responsive bg-white">
                            <table class="table table-bordered table-hover text-center">
                                <thead class="text-center" style="background-color: #4DA8DA;">
                                    <tr>
                                        ...
                                        <th class="col-2 text-capitalize">Nama Anak</th>
                                        <th class="col-2 text-capitalize">Jenis Kelamin</th>
                                        ...
                                        <th class="col-4 text-capitalize">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
                                    $nomor = 1 + (( $datakms->currentPage()-1)* $datakms->perPage());;
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>  <div class="row">
                                            <div class="col-6 text-center">
                                                <button onclick="window.location='{{ url('datakms/'.$row->id) }}'" type="button" class="btn btn-success btn-md" title="Detail">
                                                     <i class="fas fa-list"></i>
                                                </button>
                                               </div>
                                            <div class="col-6 text-center">
                                             <form onsubmit="return deleteData('{{ $row->nama_anak }}')" action="{{ url('datakms/'.$row->id) }}" method="POST"> 
                                              @csrf
                                              @method('DELETE')
                            ...
                            {!! $datakms->appends(Request::except('page'))->render() !!}
                        </div>
                    </div>
                    <script>
