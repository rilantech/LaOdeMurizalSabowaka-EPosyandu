                ...
                <!-- ============================================================== -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12 mb-4">
                            <h5 class="card-title text-center">Kesehatan Ibu Bersalin</h5>  
                        </div> 
                                    ...
                                    <tr>
                                        ...
                                        <td>  <div class="row">
                                            <div class="col-6 text-center">
                                                <button onclick="window.location='{{ url('kesehatanibubersalin/'.$row->id) }}'" type="button" class="btn btn-success btn-md" title="Detail">
