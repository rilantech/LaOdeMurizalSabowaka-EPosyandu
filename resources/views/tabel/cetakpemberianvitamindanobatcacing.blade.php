...
{{-- 
  ...
  <body >
    ...
    <h2 style="text-align: center; color:black;">Data Pemberian Vitamin & Obat Cacing</h2>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td class="col-1" colspan="2">
                                 <?php if($kapsul_biru_1 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_biru_1;
                                        }?></td>
                            <td class="col-1">
                                 <?php if($kapsul_merah_1 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_merah_1;
                                        }?>
                            ...
                            <td class="col-1">
                                 <?php if($kapsul_merah_2 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_merah_2;
                                        }?>
                            ...
                            <td class="col-1">
                                 <?php if($obat_cacing_1 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $obat_cacing_1;
                                        }?>
                           ...
                           <tr>
                              ...
                              <td class="col-1" colspan="2">
                                   <?php if($kapsul_biru_2 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_biru_2;
                                        }?>
                            ...
                            <td class="col-1">
                                  <?php if($kapsul_merah_3 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_merah_3;
                                        }?>
                            ...
                            <td class="col-1">
                                  <?php if($kapsul_merah_4 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_merah_4;
                                        }?>
                            ...
                            <td class="col-1">
                                  <?php if($obat_cacing_2 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $obat_cacing_2;
                                        }?>
                            ...
                            <td class="col-1" colspan="2">
                                  <?php if($kapsul_biru_3 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_biru_3;
                                        }?>
                            ...
                            <td class="col-1">
                                  <?php if($kapsul_merah_5 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_merah_5;
                                        }?>
                            ...
                            <td class="col-1">
                                  <?php if($kapsul_merah_6 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $kapsul_merah_6;
                                        }?>
                            ...
                            <td class="col-1">
                                  <?php if($obat_cacing_3 == '01-01-1970') {
                                        echo "";
                                       } else{
                                            echo $obat_cacing_3;
                                        }?>
            ...
            <div class="card-body text-center" style="margin-top: 20px;">
              <div class="row" style="">
                ...
                <div class="col-1" style="margin-left: 5px;">
                  {{-- <button type="button" onclick="window.location='{{ url('cetakpemberianvitamindanobatcacing/'.$id) }}'" class="btn btn-outline-dark rounded-pill fw-bold" style="width: 150px; margin-left:100px; background-color: #f1377e;">Export</button> --}}
                </div>
