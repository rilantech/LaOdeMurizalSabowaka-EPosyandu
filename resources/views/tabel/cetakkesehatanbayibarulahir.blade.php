...
{{-- 
  ...
  <body >
    ...
    <h2 style="text-align: center; color:black;">Data Kesehatan Bayi Baru Lahir</h2>
                ...
                <table class="table table-bordered table-hover text-center" id="tabelku">
                    <thead class="text-center" style="background-color: #4DA8DA;">
                        ...
                        <tr style="background-color: #9f97f0;">
                          <td class="col-1 " >Tgl : {{ $tanggal_kunjungan_1 }}</td>
                          <td class="col-1 " >Tgl : {{ $tanggal_kunjungan_2 }}</td>
                          <td class="col-1 " >Tgl : {{ $tanggal_kunjungan_3 }}</td>
                      </tr>
                    </thead>
                    <tbody>  
                      <tr>
                        <td class="col-1 text-start" style="background-color: #C7D9DD;"> 
                         ...
                         <td class="col-1 " >{{ $berat_badan_1 }}</td>
                         <td class="col-1 " >{{ $berat_badan_2 }}</td>
                         <td class="col-1 " >{{ $berat_badan_3 }}</td>
                        </tr>
                        <tr>
                          <td class="col-1 text-start" style="background-color: #C7D9DD;"> 
                              Panjang badan (cm)
                          </td>
                          <td class="col-1 " >{{ $panjang_badan_1 }}</td>
                          <td class="col-1 " >{{ $panjang_badan_2 }}</td>
                          <td class="col-1 " >{{ $panjang_badan_3 }}</td>
                          </tr>
                          <tr>
                            <td class="col-1 text-start" style="background-color: #C7D9DD;"> 
                                Suhu (℃)
                            </td>
                           <td class="col-1 " >{{ $suhu_1 }}</td>
                           <td class="col-1 " >{{ $suhu_2 }}</td>
                           <td class="col-1 " >{{ $suhu_3 }}</td>
                           ...
                           <td class="col-1 " >{{ $dan_lain_lain_1 }}</td>
                           <td class="col-1 " >{{ $dan_lain_lain_2 }}</td>
                           <td class="col-1 " >{{ $dan_lain_lain_3 }}</td>
                              </tr>
            ...
            <div class="card-body text-center" style="margin-top: 20px;">
              <div class="row" style="">
                ...
                {{-- <div class="col-1" style="margin-left: 5px;">
                  <button type="button" onclick="window.location='{{ url('cetakkesehatanbayibarulahir/'.$id) }}'" class="btn btn-outline-dark rounded-pill fw-bold" style="width: 150px; margin-left:100px; background-color: #f1377e;">Export</button>
                </div> --}}
