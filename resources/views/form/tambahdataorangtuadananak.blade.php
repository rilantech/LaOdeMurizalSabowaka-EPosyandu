...
@section('judul')
        ...
        <div class="col-12 mt-4">
            <h4 class="text-center">Tambah Data Orang Tua & Anak</h4>
        </div>
                          ...
                          @csrf
                                <div class="card-body">
                                    ...
                                    <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control  @error('nik') is-invalid @enderror" id="nik"
                                                placeholder="Masukan NIK..." name="nik" value="{{ old('nik') }}"  autofocus autocomplete="off">
                                                @error('nik')
                                                <div class="invalid-feedback text-success">
                                                  {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        <select class="form-select @error('pendidikan_ibu') is-invalid @enderror"  aria-label="Default select example" name="pendidikan_ibu" id="pendidikan_ibu">
                                          <option selected>--Pilih Pendidikan Ibu--</option>
                                          ...
                                          <option value= "S1/Sederajat" {{ old('pendidikan_ibu') }}>S1/Sederajat</option>
                                          <option value= "S2/Sederajat" {{ old('pendidikan_ibu') }}>S2/Sederajat</option>
                                          <option value= "S3/Sederajat" {{ old('pendidikan_ibu') }}>S3/Sederajat</option>
                                          <option value= "Tidak Sekolah" {{ old('pendidikan_ibu') }}>Tidak Sekolah</option>
                                        </select>
                                  ...
                                  <div class="col-6">
                                   ...
                                   <div class="col-6">
                                    ...
                                    placeholder="Tempat..." name="tempat_lahir_ibu" value="{{ old('tempat_lahir_ibu') }}"  autofocus autocomplete="off">
                                ...
                                @enderror
                                   ...
                                   <div class="col-5">
                                    ...
                                    placeholder="Tanggal" data-date-format="dd-mm-yyyy" name="tanggal_lahir_ibu" />
        ...
        <!--</script>-->
                                    ...
                                    <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        <select class="form-select @error('golongan_darah_ibu') is-invalid @enderror"  aria-label="Default select example" name="golongan_darah_ibu" id="golongan_darah">
                                          <option selected>--Pilih Golongan Darah--</option>
                                          <option value= "A" {{ old('golongan_darah_ibu') }}>A</option>
                                          <option value= "B" {{ old('golongan_darah_ibu') }}>B</option>
                                          <option value= "AB" {{ old('golongan_darah_ibu') }}>AB</option>
                                          <option value= "O" {{ old('golongan_darah_ibu') }}>O</option>
                                        </select>
                                    
                                        <!--<input type="text" class="form-control  @error('golongan_darah_ibu') is-invalid @enderror" id="golongan_darah_ibu"-->
                                        <!--        placeholder="Masukan Golongan Darah Ibu..." name="golongan_darah_ibu" value="{{ old('golongan_darah_ibu') }}"  autofocus autocomplete="off">-->
                                    ...
                                    <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control  @error('pekerjaan_ibu') is-invalid @enderror" id="pekerjaan_ibu"
                                                placeholder="Masukan Pekerjaan Ibu..." name="pekerjaan_ibu" value="{{ old('pekerjaan_ibu') }}"  autofocus autocomplete="off">
                                                @error('pekerjaan_ibu')
                                                <div class="invalid-feedback text-success">
                                                  {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control  @error('no_jkn_bpjs') is-invalid @enderror" id="no_jkn_bpjs"
                                                placeholder="Masukan No. JKN/BPJS..." name="no_jkn_bpjs" value="{{ old('no_jkn_bpjs') }}"  autofocus autocomplete="off">
                                                @error('no_jkn_bpjs')
                                                <div class="invalid-feedback text-success">
                                                  {{ $message }}
                                                </div>
                              ...
                              <div class="card-body">
                                  ...
                                  <div class="col-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control  @error('nama_ayah') is-invalid @enderror" id="nama_ayah"
                                              placeholder="Masukan Nama Suami..." name="nama_ayah" value="{{ old('nama_ayah') }}"  autofocus autocomplete="off">
                                              @error('nama_ayah')
                                              <div class="invalid-feedback text-success">
                                                {{ $message }}
                                              </div>
                                  ...
                                  <div class="col-6">
                                    <div class="form-group">
                                      ...
                                      <select class="form-select @error('pendidikan_ayah') is-invalid @enderror"  aria-label="Default select example" name="pendidikan_ayah" id="pendidikan_ayah">
                                        <option selected>--Pilih Pendidikan Suami--</option>
                                        ...
                                        <option value= "S1/Sederajat" {{ old('pendidikan_ayah') }}>S1/Sederajat</option>
                                        <option value= "S2/Sederajat" {{ old('pendidikan_ayah') }}>S2/Sederajat</option>
                                        <option value= "S3/Sederajat" {{ old('pendidikan_ayah') }}>S3/Sederajat</option>
                                        <option value= "Tidak Sekolah" {{ old('pendidikan_ayah') }}>Tidak Sekolah</option>
                                        </select>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-6">
                                    ...
                                    placeholder="Tempat..." name="tempat_lahir_ayah" value="{{ old('tempat_lahir_ayah') }}"  autofocus autocomplete="off">
                                ...
                                @enderror
                                   ...
                                   <div class="col-5">
                                    ...
                                    placeholder="Tanggal"  name="tanggal_lahir_ayah"/>
                                  ...
                                  <div class="col-6">
                                    <div class="form-group">
                                      <label for="golongan_darah_ayah" class="col-12">Golongan Darah</label>
                                       <select class="form-select @error('golongan_darah_ayah') is-invalid @enderror"  aria-label="Default select example" name="golongan_darah_ayah" id="golongan_darah">
                                          <option selected>--Pilih Golongan Darah--</option>
                                          <option value= "A" {{ old('golongan_darah_ayah') }}>A</option>
                                          <option value= "B" {{ old('golongan_darah_ayah') }}>B</option>
                                          <option value= "AB" {{ old('golongan_darah_ayah') }}>AB</option>
                                          <option value= "O" {{ old('golongan_darah_ayah') }}>O</option>
                                        </select>
                                        
                                      <!--<input type="text" class="form-control  @error('golongan_darah_ayah') is-invalid @enderror" id="golongan_darah_ayah"-->
                                      <!--        placeholder="Masukan Golongan Darah Suami..." name="golongan_darah_ayah" value="{{ old('golongan_darah_ayah') }}"  autofocus autocomplete="off">-->
                                ...
                                <div class="row">
                                  <div class="col-6">
                                    <div class="form-group">
                                      ...
                                      <select class="form-select @error('agama_ayah') is-invalid @enderror"  aria-label="Default select example" name="agama_ayah" id="agama_ayah">
                                        <option selected>--Pilih Agama Suami--</option>
                                        <option value= "Islam" {{ old('agama_ayah') }}>Islam</option>
                                        <option value= "Kristen" {{ old('agama_ayah') }}>Kristen</option>
                                        <option value= "Buddha" {{ old('agama_ayah') }}>Buddha</option>
                                        <option value= "Hindu" {{ old('agama_ayah') }}>Hindu</option>
                                        <option value= "Konghuchu" {{ old('agama_ayah') }}>Konghuchu</option>
                                      </select>
                                        @error('agama_ayah')
                                        <div class="invalid-feedback text-success">
                                          {{ $message }}
                                  ...
                                  <div class="col-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control  @error('pekerjaan_ayah') is-invalid @enderror" id="pekerjaan_ayah"
                                              placeholder="Masukan Pekerjaan Suami..." name="pekerjaan_ayah" value="{{ old('pekerjaan_ayah') }}"  autofocus autocomplete="off">
                                ...
                                <div class="col-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  @error('alamat_rumah') is-invalid @enderror" id="alamat_rumah"
                                            placeholder="Masukan Alamat Rumah..." name="alamat_rumah" value="{{ old('alamat_rumah') }}"  autofocus autocomplete="off">
                                            @error('alamat_rumah')
                                            <div class="invalid-feedback text-success">
                                              {{ $message }}
                                            </div>
                                ...
                                <div class="col-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  @error('kabupaten_atau_kota') is-invalid @enderror" id="kabupaten_atau_kota"
                                            placeholder="Masukan Alamat Rumah..." name="kabupaten_atau_kota" value="{{ old('kabupaten_atau_kota') }}"  autofocus autocomplete="off">
                                ...
                                <div class="col-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  @error('kecamatan') is-invalid @enderror" id="kecamatan"
                                            placeholder="Masukan Kecamatan..." name="kecamatan" value="{{ old('kecamatan') }}"  autofocus autocomplete="off">
                                            @error('kecamatan')
                                            <div class="invalid-feedback text-success">
                                              {{ $message }}
                                            </div>
                                ...
                                <div class="col-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  @error('no_telepon') is-invalid @enderror" id="no_telepon"
                                            placeholder="Masukan No. Telepon..." name="no_telepon" value="{{ old('no_telepon') }}"  autofocus autocomplete="off">
                                            @error('no_telepon')
                                            <div class="invalid-feedback text-success">
                                              {{ $message }}
                                            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 mx-auto p-5" style="margin-top: -90px;">
                <div class="card" style="background-color:  #4DA8DA;">
                  <div class="col-12 mt-4">
                    <h4 class="text-center">Data Anak Ke-1</h4>
                </div>
                        ...
                        <div class="card-body" style="background-color:  #4DA8DA;">
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('no_akta_kelahiran') is-invalid @enderror" id="no_akta_kelahiran"
                                        placeholder="Masukan No. JKN/BPJS Anak..." name="no_akta_kelahiran" value="{{ old('no_akta_kelahiran') }}"  autofocus autocomplete="off">
                          ...
                          <div class="row">
                            <div class="col-6">
                              <div class="form-group">
                               <label for="jenis_kelamin" class="col-12">Jenis Kelamin</label>
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('no_jkn_bpjs_anak') is-invalid @enderror" id="no_jkn_bpjs_anak"
                                        placeholder="Masukan No. JKN/BPJS Anak..." name="no_jkn_bpjs_anak" value="{{ old('no_jkn_bpjs') }}"  autofocus autocomplete="off">
                              ...
                              <div class="form-group">
                                <label for="tempat_atau_tanggal_lahir_anak" class="col-12">Tempat/Tanggal Lahir</label>
                                  <div class="row">
                                   <div class="col-6">
                                    ...
                                    placeholder="Tempat..." name="tempat_lahir_anak" value="{{ old('tempat_lahir_anak') }}"  autofocus autocomplete="off">
                                ...
                                @enderror
                                  ...
                                  <input type="date" class="form-control  @error('tanggal_lahir_anak') is-invalid @enderror" id="tanggal_lahir_anak"
                                    placeholder="Tanggal" name="tanggal_lahir_anak" value="{{ old('tanggal_lahir_anak') }}"  autofocus autocomplete="off">
                              ...
                              <div class="form-group">
                                ...
                                @enderror
                                   ...
                                   <div class="col-3">
                                    ...
                                    placeholder="" name="dari" value="{{ old('dari') }}"  autofocus autocomplete="off">
                                    @error('dari')
                                    <div class="invalid-feedback text-success">
                                      {{ $message }}
                                    </div>
                           ...
                           ' <div class="card-body" style="background-color:  #4DA8DA;">'+
                              '<div class="row">'+
                               ' <div class="col-6">'+
                                 ' <div class="form-group">'+
                                    '<label for="nama_anak" class="col-12">Nama</label>'+
                                   ' <input type="text" class="form-control  @error('nama_anak')'+
                               ...
                               ' <div class="col-6">'+
                                 ' <div class="form-group">'+
                                    '<label for="no_akta_kelahiran" class="col-12">No. Akte Kelahiran</label>'+
                                    ' <input type="text" class="form-control  @error('no_akta_kelahiran')'+
                                    'is-invalid @enderror" id="nama_anak"'+
                                            'placeholder="Masukan No Akte Kelahiran..." name="no_akta_kelahiran[]" value="{{ old('no_akta_kelahiran[]') }}"  autofocus autocomplete="off">'+
                                          '  @error('no_akta_kelahiran')'+
                                          '  <div class="invalid-feedback text-success">'+
                                             ' {{ $message }}'+
                                            '</div>'+
                             ...
                             ' <div class="row">'+
                               ' <div class="col-6">'+
                                  ...
                                  '  <label for="nama_anak" class="col-12">Jenis Kelamin</label>'+
                                   ' <select class="form-select @error('jenis_kelamin2') is-invalid @enderror"  aria-label="Default select example" name="jenis_kelamin2[]" id="jenis_kelamin">'+
                                      '<option selected>--Pilih Jenis Kelamin--</option>'+
                                     ' <option value= "Laki-Laki" {{ old('jenis_kelami2n[]') }}>Laki-Laki</option>'+
                              ...
                              '  <div class="col-6">'+
                                  '<div class="form-group">'+
                                    '<label for="no_jkn_bpjs_anak" class="col-12">No. JKN/BPJS</label>'+
                                   ' <input type="text" class="form-control  @error('no_jkn_bpjs_anak') is-invalid @enderror" id="no_jkn_bpjs_anak"'+
                                           ' placeholder="Masukan No. JKN/BPJS Anak..." name="no_jkn_bpjs_anak[]" value="{{ old('no_jkn_bpjs_anak[]') }}"  autofocus autocomplete="off">'+
                                          '  @error('no_jkn_bpjs_anak')'+
                                           ' <div class="invalid-feedback text-success">'+
                                             ' {{ $message }}'+
                                           ' </div>'+
                             ...
                             ' <div class="row">'+
                               ' <div class="col-6">'+
                                 ' <div class="form-group">'+
                                   ' <label for="tempat_atau_tanggal_lahir_anak" class="col-12">Tempat/Tanggal Lahir</label>'+
                                    '<input type="text" class="form-control  @error('tempat_atau_tanggal_lahir_anak') is-invalid @enderror" id="tempat_atau_tanggal_lahir_anak"'+
                                         '   placeholder="Masukan Tempat/Tanggal Lahir Anak" name="tempat_atau_tanggal_lahir_anak[]" value="{{ old('tempat_atau_tanggal_lahir_anak[]') }}"  autofocus autocomplete="off">'+
                                          '  @error('tempat_atau_tanggal_lahir_anak')'+
                                            '<div class="invalid-feedback text-success">'+
                                              '{{ $message }}'+
                                            '</div>'+
