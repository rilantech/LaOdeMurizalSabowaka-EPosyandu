...
@section('judul')
        ...
        <div class="col-12 mt-4">
            <h4 class="text-center fw-bold">Tambah Akun Petugas</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6 mx-auto mt-2">
                        <div class="card border-dark" style="background-color: #4DA8DA; border-radius: 30px 30px 30px 30px; border:solid 3px black;">
                            <form class="form-horizontal" action='{{  url('daftarakunpetugas') }}' method='post'>
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control  @error('nama') is-invalid @enderror" id="nama"
                                                placeholder="Masukan Nama..." name="nama" value="{{ old('nama') }}"  autofocus autocomplete="off">
                                                @error('nama')
                                    ...
                                    <div class="form-group">
                                      <label for="nomor_hp" class="col-12 text-start control-label col-form-label fw-bold">Nomor HP</label>
                                          <input type="text" class="form-control @error('nomor_hp') is-invalid @enderror" id="nomor_hp"
                                              placeholder="Masukan Nomor HP..."  name="nomor_hp" value="{{ old('nomor_hp') }}" >
                                              @error('nomor_hp')
                                              <div class="invalid-feedback text-dark">
                                                {{ $message }}
                                              </div>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" class="btn bg-success btn-outline-dark rounded-pill fw-bold" style="width: 100px;">Simpan</button>
                                    </form>
                                        <button type="button" onclick="window.location='{{ url('daftarakunpetugas') }}'" class="btn btn-outline-dark rounded-pill fw-bold" style="width: 100px; background-color: rgb(255, 251, 13);">Batal</button>
                                    </div>
