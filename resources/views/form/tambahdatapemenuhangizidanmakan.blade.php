...
@section('judul')
        ...
        <div class="col-12 mt-4">
            <h4 class="text-center">Tambah Data Pemenuhan Gizi & Makan</h4>
                ...
                <div class="row">
                    <div class="col-md-12 mx-auto mt-2 p-5">
                      ...
                      placeholder="Masukan Nama Ibu..." name="id" value="{{ $id }}" autofocus autocomplete="off" hidden> --}}
                                ...
                                <form action="{{ url('pemenuhangizidanmakan') }}" method='post'>
                                  @csrf
                                  <div class="row">
                                    <div class="col-6">
                                      <div class="form-group">
                                  ...
                                  <div class="row">
                                    <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        @if($dataorangtua2 != null)
                                        @foreach ($dataorangtua2 as $item1)
                                        <select class="form-select @error('nik') is-invalid @enderror" aria-label="Default select example" name="nama_anak" id="nik" onchange="window.location.href='tambahpemenuhangizidanmakan?nik={{ $item1->nik }}&namaanak='+this.value">
                                ...
                                <td class="text-start" style="background-color: #88C273;" colspan="3"> 
                                 ...
                                 <tr>
                                    ...
                                    <th class="col-1"><input type="text" class="form-control @error('nol_sampai_enam_bulan_1') is-invalid @enderror" id="nol_sampai_enam_bulan_1"
                                      placeholder="..." name="nol_sampai_enam_bulan_1" value="{{ old('nol_sampai_enam_bulan_1') }}"  autofocus autocomplete="off">
                                   </th>
                                    <th class="col-1"><input type="text" class="form-control @error('nol_sampai_enam_bulan_2') is-invalid @enderror" id="$item->nol_sampai_enam_bulan_2"
                                      placeholder="..." name="nol_sampai_enam_bulan_2" value="{{ old('nol_sampai_enam_bulan_2') }}"  autofocus autocomplete="off"></th>
                                    <th class="col-1">
                                      <input type="text" class="form-control  @error('nol_sampai_enam_bulan_3') is-invalid @enderror" id="nol_sampai_enam_bulan_3"
                                      placeholder="..." name="nol_sampai_enam_bulan_3" value="{{ old('nol_sampai_enam_bulan_3') }}"  autofocus autocomplete="off">
                                    </th>
                                    <th class="col-1">
                                      <input type="text" class="form-control  @error('nol_sampai_enam_bulan_4') is-invalid @enderror" id="nol_sampai_enam_bulan_4"
                                      placeholder="..." name="nol_sampai_enam_bulan_4" value="{{ old('nol_sampai_enam_bulan_4') }}"  autofocus autocomplete="off">
                                    </th>
                                  </tr>
                                   <tr>
                                      <td class="text-start" colspan="3" > 
                                      ...
                                      <th class="col-1"><input type="text" class="form-control @error('enam_sampai_sebelas_bulan_1') is-invalid @enderror" id="enam_sampai_sebelas_bulan_1"
                                        placeholder="..." name="enam_sampai_sebelas_bulan_1" value="{{ old('enam_sampai_sebelas_bulan_1') }}"  autofocus autocomplete="off">
                                      ...
                                      <th class="col-1"><input type="text" class="form-control @error('enam_sampai_sebelas_bulan_2') is-invalid @enderror" id="$item->enam_sampai_sebelas_bulan_2"
                                        placeholder="..." name="enam_sampai_sebelas_bulan_2" value="{{ old('enam_sampai_sebelas_bulan_2') }}"  autofocus autocomplete="off"></th>
                                      <th class="col-1">
                                        <input type="text" class="form-control  @error('enam_sampai_sebelas_bulan_3') is-invalid @enderror" id="enam_sampai_sebelas_bulan_3"
                                        placeholder="..." name="enam_sampai_sebelas_bulan_3" value="{{ old('enam_sampai_sebelas_bulan_3') }}"  autofocus autocomplete="off">
                                      </th>
                                      <th class="col-1">
                                        <input type="text" class="form-control  @error('enam_sampai_sebelas_bulan_4') is-invalid @enderror" id="enam_sampai_sebelas_bulan_4"
                                        placeholder="..." name="enam_sampai_sebelas_bulan_4" value="{{ old('enam_sampai_sebelas_bulan_4') }}"  autofocus autocomplete="off">
                                      </th>
                                     </tr>
                                     <tr>
                                      <td class="text-start" colspan="3" > 
                                      ...
                                      <th class="col-1"><input type="text" class="form-control @error('lainnya_1') is-invalid @enderror" id="lainnya_1"
                                        placeholder="..." name="lainnya_1" value="{{ old('lainnya_1') }}"  autofocus autocomplete="off">
                                       
                                     </th>
                                      <th class="col-1"><input type="text" class="form-control @error('lainnya_2') is-invalid @enderror" id="$item->lainnya_2"
                                        placeholder="..." name="lainnya_2" value="{{ old('lainnya_2') }}"  autofocus autocomplete="off"></th>
                                      <th class="col-1">
                                        <input type="text" class="form-control  @error('lainnya_3') is-invalid @enderror" id="lainnya_3"
                                        placeholder="..." name="lainnya_3" value="{{ old('lainnya_3') }}"  autofocus autocomplete="off">
                                      </th>
                                      <th class="col-1">
                                        <input type="text" class="form-control  @error('lainnya_4') is-invalid @enderror" id="lainnya_4"
                                        placeholder="..." name="lainnya_4" value="{{ old('lainnya_4') }}"  autofocus autocomplete="off">
                                      </th>
                                     </tr>
