...
@section('judul')
        ...
        <div class="col-12 mt-4">
            <h4 class="text-center">Edit Jadwal Posyandu</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6 mx-auto mt-2">
                        <div class="card" style="background-color: #4791D1;">
                            <form class="form-horizontal" action='{{  url('jadwalposyandu/'.$id) }}' method='post'>
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                  <input  hidden
                                 name="waktu_post" value="{{ $waktu_post }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control  @error('agenda') is-invalid @enderror" id="agenda"
                                                placeholder="Masukan agenda" name="agenda" value="{{ $agenda }}"  autofocus autocomplete="off">
                                                @error('agenda')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="datepicker" name="tanggal" class="@error('tanggal') is-invalid @enderror" value="{{  $tanggal }}">
                                        @error('tanggal')
                                      <div class="invalid-feedback">
                                        {{ $message }}
                                      </div>
                                    ...
                                    <div class="form-group">
                                        <label for="jam" class="col-12 text-start control-label col-form-label">Jam Pelaksanaan</label>
                                            <input type="time" class="form-control @error('jam') is-invalid @enderror" id="lname"
                                                placeholder="Masukan Jam Pelaksanaan"  name="jam" value="{{ $jam }}" >
                                                @error('jam')
                                                <div class="invalid-feedback">
                                                  {{ $message }}
                                                </div>
