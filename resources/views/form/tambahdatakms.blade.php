...
@section('judul')
        ...
        <div class="col-12 mt-4">
            <h4 class="text-center">Tambah Data KMS</h4>
                              ...
                              <tr>
                                <td class="text-start" style="background-color: #88C273;" colspan="3"> 
                                  ...
                                  <th class="col-1">
                                    ...
                                    placeholder="..." name="bulan_penimbangan_14" value="{{ old('bulan_penimbangan_14') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_15') is-invalid @enderror" id="bulan_penimbangan_15"
                                    placeholder="..." name="bulan_penimbangan_15" value="{{ old('bulan_penimbangan_15') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_16') is-invalid @enderror" id="bulan_penimbangan_16"
                                    placeholder="..." name="bulan_penimbangan_16" value="{{ old('bulan_penimbangan_16') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th><input type="date" class="form-control @error('bulan_penimbangan_17') is-invalid @enderror" id="bulan_penimbangan_17"
                                    placeholder="..." name="bulan_penimbangan_17" value="{{ old('bulan_penimbangan_17') }}"  autofocus autocomplete="off" style="width: 100px;">
                                   
                                 </th>
                                  <th class="col-1"><input type="date" class="form-control @error('bulan_penimbangan_18') is-invalid @enderror" id="bulan_penimbangan_18"
                                    placeholder="..." name="bulan_penimbangan_18" value="{{ old('bulan_penimbangan_18') }}"  autofocus autocomplete="off" style="width: 100px;"></th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_19') is-invalid @enderror" id="bulan_penimbangan_19"
                                    placeholder="..." name="bulan_penimbangan_19" value="{{ old('bulan_penimbangan_19') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_20') is-invalid @enderror" id="bulan_penimbangan_20"
                                    placeholder="..." name="bulan_penimbangan_20" value="{{ old('bulan_penimbangan_20') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_21') is-invalid @enderror" id="bulan_penimbangan_21"
                                    placeholder="..." name="bulan_penimbangan_21" value="{{ old('bulan_penimbangan_21') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_22') is-invalid @enderror" id="bulan_penimbangan_22"
                                    placeholder="..." name="bulan_penimbangan_22" value="{{ old('bulan_penimbangan_22') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_23') is-invalid @enderror" id="bulan_penimbangan_23"
                                    placeholder="..." name="bulan_penimbangan_23" value="{{ old('bulan_penimbangan_23') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_24') is-invalid @enderror" id="bulan_penimbangan_24"
                                    placeholder="..." name="bulan_penimbangan_24" value="{{ old('bulan_penimbangan_24') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_25') is-invalid @enderror" id="bulan_penimbangan_25"
                                    placeholder="..." name="bulan_penimbangan_25" value="{{ old('bulan_penimbangan_25') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_26') is-invalid @enderror" id="bulan_penimbangan_26"
                                    placeholder="..." name="bulan_penimbangan_26" value="{{ old('bulan_penimbangan_26') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_27') is-invalid @enderror" id="bulan_penimbangan_27"
                                    placeholder="..." name="bulan_penimbangan_27" value="{{ old('bulan_penimbangan_27') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_28') is-invalid @enderror" id="bulan_penimbangan_28"
                                    placeholder="..." name="bulan_penimbangan_28" value="{{ old('bulan_penimbangan_28') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_29') is-invalid @enderror" id="bulan_penimbangan_29"
                                    placeholder="..." name="bulan_penimbangan_29" value="{{ old('bulan_penimbangan_29') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_30') is-invalid @enderror" id="bulan_penimbangan_30"
                                    placeholder="..." name="bulan_penimbangan_30" value="{{ old('bulan_penimbangan_30') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_31') is-invalid @enderror" id="bulan_penimbangan_31"
                                    placeholder="..." name="bulan_penimbangan_31" value="{{ old('bulan_penimbangan_31') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_32') is-invalid @enderror" id="bulan_penimbangan_32"
                                    placeholder="..." name="bulan_penimbangan_32" value="{{ old('bulan_penimbangan_32') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_33') is-invalid @enderror" id="bulan_penimbangan_33"
                                    placeholder="..." name="bulan_penimbangan_33" value="{{ old('bulan_penimbangan_33') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th><input type="date" class="form-control @error('bulan_penimbangan_34') is-invalid @enderror" id="bulan_penimbangan_34"
                                    placeholder="..." name="bulan_penimbangan_34" value="{{ old('bulan_penimbangan_34') }}"  autofocus autocomplete="off" style="width: 100px;">
                                   
                                 </th>
                                  <th class="col-1"><input type="date" class="form-control @error('bulan_penimbangan_35') is-invalid @enderror" id="bulan_penimbangan_35"
                                    placeholder="..." name="bulan_penimbangan_35" value="{{ old('bulan_penimbangan_35') }}"  autofocus autocomplete="off" style="width: 100px;"></th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_36') is-invalid @enderror" id="bulan_penimbangan_36"
                                    placeholder="..." name="bulan_penimbangan_36" value="{{ old('bulan_penimbangan_36') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_37') is-invalid @enderror" id="bulan_penimbangan_37"
                                    placeholder="..." name="bulan_penimbangan_37" value="{{ old('bulan_penimbangan_37') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_38') is-invalid @enderror" id="bulan_penimbangan_38"
                                    placeholder="..." name="bulan_penimbangan_38" value="{{ old('bulan_penimbangan_38') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_39') is-invalid @enderror" id="bulan_penimbangan_39"
                                    placeholder="..." name="bulan_penimbangan_39" value="{{ old('bulan_penimbangan_39') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_40') is-invalid @enderror" id="bulan_penimbangan_40"
                                    placeholder="..." name="bulan_penimbangan_40" value="{{ old('bulan_penimbangan_40') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_41') is-invalid @enderror" id="bulan_penimbangan_41"
                                    placeholder="..." name="bulan_penimbangan_41" value="{{ old('bulan_penimbangan_41') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_42') is-invalid @enderror" id="bulan_penimbangan_42"
                                    placeholder="..." name="bulan_penimbangan_42" value="{{ old('bulan_penimbangan_42') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_43') is-invalid @enderror" id="bulan_penimbangan_43"
                                    placeholder="..." name="bulan_penimbangan_43" value="{{ old('bulan_penimbangan_43') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_44') is-invalid @enderror" id="bulan_penimbangan_44"
                                    placeholder="..." name="bulan_penimbangan_44" value="{{ old('bulan_penimbangan_44') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_45') is-invalid @enderror" id="bulan_penimbangan_45"
                                    placeholder="..." name="bulan_penimbangan_45" value="{{ old('bulan_penimbangan_45') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_46') is-invalid @enderror" id="bulan_penimbangan_46"
                                    placeholder="..." name="bulan_penimbangan_46" value="{{ old('bulan_penimbangan_46') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_47') is-invalid @enderror" id="bulan_penimbangan_47"
                                    placeholder="..." name="bulan_penimbangan_47" value="{{ old('bulan_penimbangan_47') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_48') is-invalid @enderror" id="bulan_penimbangan_48"
                                    placeholder="..." name="bulan_penimbangan_48" value="{{ old('bulan_penimbangan_48') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_49') is-invalid @enderror" id="bulan_penimbangan_49"
                                    placeholder="..." name="bulan_penimbangan_49" value="{{ old('bulan_penimbangan_49') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_50') is-invalid @enderror" id="bulan_penimbangan_50"
                                    placeholder="..." name="bulan_penimbangan_50" value="{{ old('bulan_penimbangan_50') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th><input type="date" class="form-control @error('bulan_penimbangan_51') is-invalid @enderror" id="bulan_penimbangan_51"
                                    placeholder="..." name="bulan_penimbangan_51" value="{{ old('bulan_penimbangan_51') }}"  autofocus autocomplete="off" style="width: 100px;">
                                   
                                 </th>
                                  <th class="col-1"><input type="date" class="form-control @error('bulan_penimbangan_52') is-invalid @enderror" id="bulan_penimbangan_52"
                                    placeholder="..." name="bulan_penimbangan_52" value="{{ old('bulan_penimbangan_52') }}"  autofocus autocomplete="off" style="width: 100px;"></th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_53') is-invalid @enderror" id="bulan_penimbangan_53"
                                    placeholder="..." name="bulan_penimbangan_53" value="{{ old('bulan_penimbangan_53') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_54') is-invalid @enderror" id="bulan_penimbangan_54"
                                    placeholder="..." name="bulan_penimbangan_54" value="{{ old('bulan_penimbangan_54') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_55') is-invalid @enderror" id="bulan_penimbangan_55"
                                    placeholder="..." name="bulan_penimbangan_55" value="{{ old('bulan_penimbangan_55') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_56') is-invalid @enderror" id="bulan_penimbangan_56"
                                    placeholder="..." name="bulan_penimbangan_56" value="{{ old('bulan_penimbangan_56') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_57') is-invalid @enderror" id="bulan_penimbangan_57"
                                    placeholder="..." name="bulan_penimbangan_57" value="{{ old('bulan_penimbangan_57') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_58') is-invalid @enderror" id="bulan_penimbangan_58"
                                    placeholder="..." name="bulan_penimbangan_58" value="{{ old('bulan_penimbangan_58') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_59') is-invalid @enderror" id="bulan_penimbangan_59"
                                    placeholder="..." name="bulan_penimbangan_59" value="{{ old('bulan_penimbangan_59') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
                                  <th class="col-1">
                                    <input type="date" class="form-control  @error('bulan_penimbangan_60') is-invalid @enderror" id="bulan_penimbangan_60"
                                    placeholder="..." name="bulan_penimbangan_60" value="{{ old('bulan_penimbangan_60') }}"  autofocus autocomplete="off" style="width: 100px;">
                                  </th>
