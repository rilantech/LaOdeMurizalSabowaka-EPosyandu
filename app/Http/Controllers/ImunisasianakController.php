...
use App\Http\Requests\TambahImunisasiAnakRequest;
...
class ImunisasianakController extends Controller
{
     ...
     */
    public function store(TambahImunisasiAnakRequest $request)
    {
    ...
    public function show(HttpRequest $request, Dataimunisasianak $dataimunisasianak1, $id)
    {
        ...
        return view('form.detaildataimunisasianak')->with([
            ...
            'hepatitis_0' => $data1->hepatitis_0,
            'hepatitis_1' => $data1->hepatitis_1,
            'hepatitis_2' => $data1->hepatitis_2,
            'hepatitis_3' => $data1->hepatitis_3,
            'hepatitis_4' => $data1->hepatitis_4,
            'hepatitis_5' => $data1->hepatitis_5,
            'hepatitis_6' => $data1->hepatitis_6,
            'hepatitis_7' => $data1->hepatitis_7,
            'hepatitis_8' => $data1->hepatitis_8,
            'hepatitis_9' => $data1->hepatitis_9,
            'hepatitis_10' => $data1->hepatitis_10,
            'hepatitis_11' => $data1->hepatitis_11,
            'hepatitis_12' => $data1->hepatitis_12,
            'bcg_0' => $data1->bcg_0,
            'bcg_1' => $data1->bcg_1,
            'bcg_2' => $data1->bcg_2,
            'bcg_3' => $data1->bcg_3,
            ...
            'bcg_11' => $data1->bcg_11,
            'bcg_12' => $data1->bcg_12,
            'polio_tetes_0' => $data1->polio_tetes_0,
            'polio_tetes_1' => $data1->polio_tetes_1,
            'polio_tetes_2' => $data1->polio_tetes_2,
            'polio_tetes_3' => $data1->polio_tetes_3,
            'polio_tetes_4' => $data1->polio_tetes_4,
            'polio_tetes_5' => $data1->polio_tetes_5,
            'polio_tetes_6' => $data1->polio_tetes_6,
            'polio_tetes_7' => $data1->polio_tetes_7,
            'polio_tetes_8' => $data1->polio_tetes_8,
            'polio_tetes_9' => $data1->polio_tetes_9,
            'polio_tetes_10' => $data1->polio_tetes_10,
            'polio_tetes_11' => $data1->polio_tetes_11,
            'polio_tetes_12' => $data1->polio_tetes_12,
            'dan_lain_lain_0' => $data1->dan_lain_lain_0,
            'dan_lain_lain_1' => $data1->dan_lain_lain_1,
            'dan_lain_lain_2' => $data1->dan_lain_lain_2,
            'dan_lain_lain_3' => $data1->dan_lain_lain_3,
            'dan_lain_lain_4' => $data1->dan_lain_lain_4,
            'dan_lain_lain_5' => $data1->dan_lain_lain_5,
            'dan_lain_lain_6' => $data1->dan_lain_lain_6,
            'dan_lain_lain_7' => $data1->dan_lain_lain_7,
            'dan_lain_lain_8' => $data1->dan_lain_lain_8,
            'dan_lain_lain_9' => $data1->dan_lain_lain_9,
            'dan_lain_lain_10' => $data1->dan_lain_lain_10,
            'dan_lain_lain_11' => $data1->dan_lain_lain_11,
            'dan_lain_lain_12' => $data1->dan_lain_lain_12,
