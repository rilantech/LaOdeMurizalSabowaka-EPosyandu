...
class Matrikpemantauanperkembangananak extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $datamatriksperkembangananak1->nama_ayah= $request->nama_ayah;
    ...
    public function show(HttpRequest $request, Matrikspemantauanperkembangananak $datamatriksperkembangananak1, $id)
    {
        ...
        return view('form.detaildatamatrikspemantauanperkembangananak')->with([
      ...
      'tanggal_pemantauan_selanjutnya_72' => $data1->tanggal_pemantauan_selanjutnya_72,
            ...
            'title' => 'Detail Data Matriks Pemantauan Perkembangan Anak',
        ]);
    }
