...
class ApiDatakms extends Controller
{
    /**
     ...
     */
     ...
     {
         $datakms = ModelsDatakms::latest()->get();
  ...
  $datakms->asi_eksklusif_0 = $request->asi_eksklusif_0;
  $datakms->asi_eksklusif_1 = $request->asi_eksklusif_1;
   $datakms->asi_eksklusif_2 = $request->asi_eksklusif_2;
  $datakms->asi_eksklusif_3 = $request->asi_eksklusif_3;
  $datakms->asi_eksklusif_4 = $request->asi_eksklusif_4;
  $datakms->asi_eksklusif_5 = $request->asi_eksklusif_5;
  $datakms->asi_eksklusif_6 = $request->asi_eksklusif_6;
   $datakms->save();
   ...
   return response()->json([
    ...
    {
        $data2  = ModelsDatakms::where('nik_ibu', $request->nik_ibu)->get();
