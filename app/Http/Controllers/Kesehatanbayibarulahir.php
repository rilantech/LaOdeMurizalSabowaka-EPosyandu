...
use App\Http\Requests\TambahKesehatanBayiBaruLahirRequest;
...
class Kesehatanbayibarulahir extends Controller
{
    /**
    ...
    public function index(HttpRequest $request)
    {
        ...
        if(!empty($search)){
            $datakesehatanBayibarulahir = Datakesehatanbayibarulahir::where('tabel_kesehatan_bayi_baru_lahir.id','like','%'.$search.'%')
           ->orwhere('tabel_kesehatan_bayi_baru_lahir.nama_anak','like','%'.$search.'%')
           ->paginate(10)->onEachSide(2)->fragment('srv');
        }else{
            $datakesehatanBayibarulahir = Datakesehatanbayibarulahir::latest()->paginate(10)->onEachSide(2)->fragment('srv');
        }
        return view('tabel.halamankesehatanbayibarulahir',[
            'title' => 'Kesehatan Bayi Baru Lahir',
            'datakesehatanbayibarulahir' => $datakesehatanBayibarulahir,
            'search' => $search
          ]
          );
}
     ...
     */
    public function store(TambahKesehatanBayiBaruLahirRequest $request)
    {
        ...
        return redirect('kesehatanbayibarulahir')->with('msg','Data Berhasil Di Tambahkan');
    }
    ...
    public function tambahkesehatanbayibarulahir(HttpRequest $request){
        $nik = $request->query('nik');
   ...
   return view('form.tambahkesehatanbayibarulahir')->with([
        'dataorangtua1' => $dataOrangtua,
        'dataorangtua2' => $dataorangtu,
        'dataanak' => $dataanak,
        'dataanak1' => $dataanak1,
