...
class CetakKesehatanibunifasController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $datakeshatanibunifas->keadaan_ibu = $keadaan_ibu1. "," . $keadaan_ibu2 . "," . $keadaan_ibu3; 
        $datakeshatanibunifas->komplikasi_nifas = $komplikasi_nifas1. "," . $komplikasi_nifas2 . "," . $komplikasi_nifas3 . "," . $komplikasi_nifas4; 
        $datakeshatanibunifas->keadaan_bayi =  $keadaan_bayi1. "," . $keadaan_bayi2 . "," . $keadaan_bayi3 . "," . $keadaan_bayi4; 
    ...
    public function show(Dataorangtua $dataorangtua1, $id)
    {
        ...
        return view('tabel.cetakkesehatanibunifas')->with([
            'id' => $id,
            'nik' => $data1->nik,
            'nama_ibu' => $data1->nama_ibu,
            'data2' => $data2,
            'title' => 'Cetak Kesehatan Ibu Nifas',
        ]);
    }
    /**
    ...
    public function update(Request $request, Datakesehatanibunifas $datakesehatanibunifas3, $id)
    {
        ...
        ->update(
            [
                ...
                'keadaan_ibu' => $keadaan_ibu1. "," . $keadaan_ibu2 . "," . $keadaan_ibu3, 
                'komplikasi_nifas' => $komplikasi_nifas1. "," . $komplikasi_nifas2 . "," . $komplikasi_nifas3 . "," . $komplikasi_nifas4, 
                'keadaan_bayi' =>  $keadaan_bayi1. "," . $keadaan_bayi2 . "," . $keadaan_bayi3 . "," . $keadaan_bayi4
