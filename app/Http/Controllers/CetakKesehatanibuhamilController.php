...
class CetakKesehatanibuhamilController extends Controller
{
    ...
    public function store(TambahKesehatanIbuHamilRequest $request)
    {
      ...
      if($nik4 != null){
        ...
        $catatankesehatanibuhamil->kehamilan_ke= $request->kehamilan_ke1;
...
$datakesehatanibuhamil->save();
    ...
    public function show(HttpRequest $request, Dataorangtua $dataorangtua1, $id)
    {
        ...
        return view('tabel.cetakkesehatanibuhamil')->with([
            'id' => $id,
            'nik' => $data1->nik,
            ...
            'title' => 'Cetak Data Kesehatan Ibu Hamil',
    ...
    public function update(Request $request, Datakesehatanibuhamil $datakesehatanibuhamil2, Catatankesehatanibuhamil $catatankesehatanibuhamil2, $id2)
    {
      ...
      for($i = 0; $i < count($nik2); $i++){
       ...
       return redirect('kesehatanibuhamil/'.$id2.'?kehamilan_keberapa='.$request->kehamilan_ke[$i])->with('msg','Data Berhasil Di Update');
        }
    }
