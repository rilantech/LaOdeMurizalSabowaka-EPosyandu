...
use App\Http\Requests\TambahDataKMSRequest;
...
class Datakms extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $datakms->nama_ayah= $request->nama_ayah;
   ...
   $datakms->save();
    ...
    public function show(HttpRequest $request, ModelsDatakms $datakms1, $id)
    {
        ...
        if($status_bb_40 >= 10.1  and $status_bb_40 < 11.3){
         ...
         //Berat Badan 41 Bulan
        $status_bb_41 = (float) $data1->bb_41;
        if($status_bb_41 >= 10.2  and $status_bb_41 < 11.5){
            $status_beratbadan_41 = "Berat Badan Kurang";
        }
        else if($status_bb_41 < 10.2){
            $status_beratbadan_41 = "Berat Badan Sangat Kurang";
            if($data1->bb_41 ==""){
            $status_beratbadan_41 = "-";
            }
       } else if($status_bb_41 >= 11.5 and $status_bb_41 <= 19.5){
            $status_beratbadan_41 = "Berat Badan Normal";
        
        }else if($status_bb_41 > 19.5){
            $status_beratbadan_41 = "Berat Badan Resiko Lebih";
        }
        else{
            $status_beratbadan_41 ="";
        }
        
         //Berat Badan 42 Bulan
        $status_bb_42 = (float) $data1->bb_42;
        if($status_bb_42 >= 10.4  and $status_bb_42 < 11.6){
            $status_beratbadan_42 = "Berat Badan Kurang";
        }
        else if($status_bb_42 < 10.4){
            $status_beratbadan_42 = "Berat Badan Sangat Kurang";
            if($data1->bb_42 ==""){
            $status_beratbadan_42 = "-";
            }
       } else if($status_bb_42 >= 11.6 and $status_bb_42 <= 19.8){
            $status_beratbadan_42 = "Berat Badan Normal";
        
        }else if($status_bb_42 > 19.8){
            $status_beratbadan_42 = "Berat Badan Resiko Lebih";
        }
        else{
            $status_beratbadan_42 ="";
        }
        ...
        return view('form.detaildatakms')->with([
           ...
           'bulan_penimbangan_0' => $data1->bulan_penimbangan_0,
           'bulan_penimbangan_1' => $data1->bulan_penimbangan_1,
           'bulan_penimbangan_2' => $data1->bulan_penimbangan_2,
           'bulan_penimbangan_3' => $data1->bulan_penimbangan_3,
           'bulan_penimbangan_4' => $data1->bulan_penimbangan_4,
           'bulan_penimbangan_5' => $data1->bulan_penimbangan_5,
           'bulan_penimbangan_6' => $data1->bulan_penimbangan_6,
           'bulan_penimbangan_7' => $data1->bulan_penimbangan_7,
           'bulan_penimbangan_8' => $data1-> bulan_penimbangan_8,
            'bulan_penimbangan_9' => $data1->bulan_penimbangan_9,
           'bulan_penimbangan_10' => $data1->bulan_penimbangan_10,
         'bulan_penimbangan_11' => $data1->bulan_penimbangan_11,
         'bulan_penimbangan_12' => $data1->bulan_penimbangan_12,
         'bulan_penimbangan_13' => $data1->bulan_penimbangan_13,
         'bulan_penimbangan_14' => $data1->bulan_penimbangan_14,
         'bulan_penimbangan_15' => $data1->bulan_penimbangan_15,
         'bulan_penimbangan_16' => $data1->bulan_penimbangan_16,
         'bulan_penimbangan_17' => $data1->bulan_penimbangan_17,
         'bulan_penimbangan_18' => $data1->bulan_penimbangan_18,
         'bulan_penimbangan_19' => $data1->bulan_penimbangan_19,
         'bulan_penimbangan_20' => $data1->bulan_penimbangan_20,
         'bulan_penimbangan_21' => $data1->bulan_penimbangan_21,
         'bulan_penimbangan_22' => $data1->bulan_penimbangan_22,
         'bulan_penimbangan_23' => $data1->bulan_penimbangan_23,
         'bulan_penimbangan_24' => $data1->bulan_penimbangan_24,
         'bulan_penimbangan_25' => $data1->bulan_penimbangan_25,
         'bulan_penimbangan_26' => $data1->bulan_penimbangan_26,
         'bulan_penimbangan_27' => $data1->bulan_penimbangan_27,
         'bulan_penimbangan_28' => $data1->bulan_penimbangan_28,
         'bulan_penimbangan_29' => $data1->bulan_penimbangan_29,
         'bulan_penimbangan_30' => $data1->bulan_penimbangan_30,
         'bulan_penimbangan_31' => $data1->bulan_penimbangan_31,
         'bulan_penimbangan_32' => $data1->bulan_penimbangan_32,
         'bulan_penimbangan_33' => $data1->bulan_penimbangan_33,
         'bulan_penimbangan_34' => $data1->bulan_penimbangan_34,
         'bulan_penimbangan_35' => $data1->bulan_penimbangan_35,
         'bulan_penimbangan_36' => $data1->bulan_penimbangan_36,
         'bulan_penimbangan_37' => $data1->bulan_penimbangan_37,
         'bulan_penimbangan_38' => $data1->bulan_penimbangan_38,
         'bulan_penimbangan_39' => $data1->bulan_penimbangan_39,
         'bulan_penimbangan_40' => $data1->bulan_penimbangan_40,
         'bulan_penimbangan_41' => $data1->bulan_penimbangan_41,
         'bulan_penimbangan_42' => $data1->bulan_penimbangan_42,
         'bulan_penimbangan_43' => $data1->bulan_penimbangan_43,
         'bulan_penimbangan_44' => $data1->bulan_penimbangan_44,
         'bulan_penimbangan_45' => $data1->bulan_penimbangan_45,
         'bulan_penimbangan_46' => $data1->bulan_penimbangan_46,
         'bulan_penimbangan_47' => $data1->bulan_penimbangan_47,
         'bulan_penimbangan_48' => $data1->bulan_penimbangan_48,
         'bulan_penimbangan_49' => $data1->bulan_penimbangan_49,
         'bulan_penimbangan_50' => $data1->bulan_penimbangan_50,
         'bulan_penimbangan_51' => $data1->bulan_penimbangan_51,
         'bulan_penimbangan_52' => $data1->bulan_penimbangan_52,
         'bulan_penimbangan_53' => $data1->bulan_penimbangan_53,
         'bulan_penimbangan_54' => $data1->bulan_penimbangan_54,
         'bulan_penimbangan_55' => $data1->bulan_penimbangan_55,
         'bulan_penimbangan_56' => $data1->bulan_penimbangan_56,
         'bulan_penimbangan_57' => $data1->bulan_penimbangan_57,
         'bulan_penimbangan_58' => $data1->bulan_penimbangan_58,
         'bulan_penimbangan_59' => $data1->bulan_penimbangan_59,
         'bulan_penimbangan_60' => $data1->bulan_penimbangan_60,
...
$data->asi_eksklusif_0 = $request->asi_eksklusif_0;
$data->asi_eksklusif_1 = $request->asi_eksklusif_1;
$data->asi_eksklusif_2 = $request->asi_eksklusif_2;
$data->asi_eksklusif_3 = $request->asi_eksklusif_3;
$data->asi_eksklusif_4 = $request->asi_eksklusif_4;
$data->asi_eksklusif_5 = $request->asi_eksklusif_5;
$data->asi_eksklusif_6 = $request->asi_eksklusif_6;
        $data->save();
