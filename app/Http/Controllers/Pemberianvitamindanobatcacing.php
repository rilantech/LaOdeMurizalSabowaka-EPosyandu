...
use App\Http\Requests\TambahPemberianVitaminDanObatCacingRequest;
...
class Pemberianvitamindanobatcacing extends Controller
{
    /**
     ...
     */
    public function store(TambahPemberianVitaminDanObatCacingRequest $request)
    {
    ...
    public function show(HttpRequest $request, Datapemberianvitamindanobatcacing $pemberianvitamindanobatcacing1, $id)
    {
        ...
        return view('form.detaildatapemberianvitamindanobatcacing')->with([
            ...
            'kapsul_biru_1' => $data1->kapsul_biru_1,
            'kapsul_merah_1' => $data1->kapsul_merah_1,
            'kapsul_merah_2' => $data1->kapsul_merah_2,
            'obat_cacing_1' => $data1->obat_cacing_1,
            'kapsul_biru_2' => $data1->kapsul_biru_2,
            'kapsul_merah_3' => $data1->kapsul_merah_3,
            'kapsul_merah_4' => $data1->kapsul_merah_4,
            'obat_cacing_2' => $data1->obat_cacing_2,
            'kapsul_biru_3' => $data1->kapsul_biru_3,
            'kapsul_merah_5' => $data1->kapsul_merah_5,
            'kapsul_merah_6' => $data1->kapsul_merah_6,
            'obat_cacing_3' => $data1->obat_cacing_3,
            'title' => 'Detail Pemberian Vitamin & Obat Cacing',
        ]);
    }
