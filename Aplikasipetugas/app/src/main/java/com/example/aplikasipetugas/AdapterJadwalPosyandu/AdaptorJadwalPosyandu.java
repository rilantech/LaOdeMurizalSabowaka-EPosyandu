package com.example.aplikasipetugas.AdapterJadwalPosyandu;
...
public class AdaptorJadwalPosyandu extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        @SuppressLint("ViewHolder") View view1 = this.inflater.inflate((int) R.layout.list_jadwal_posyandu, (ViewGroup) null);
        if (view1 != null) {
