...
import com.example.aplikasipetugas.Pemberian_vitamin_dan_obat_cacing;
...
public class AdaptorDataPemberianVitaminDanObatCacing extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        view1 = this.inflater.inflate((int) R.layout.list_pemberian_vitamin_dan_obat_cacing, (ViewGroup) null);
        if (view1 != null) {
            ...
            ((ImageView) view1.findViewById(R.id.tomboleksport)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(AdaptorDataPemberianVitaminDanObatCacing.this.context.getApplicationContext(), Pemberian_vitamin_dan_obat_cacing.class);
                    intent.addFlags(268435456);
                    intent.putExtra("UploadTaskParameters.Companion.CodingKeys.id", AdaptorDataPemberianVitaminDanObatCacing.this.model.get(position).getId());
                    intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT|Intent.FLAG_ACTIVITY_NEW_TASK);
                    AdaptorDataPemberianVitaminDanObatCacing.this.context.getApplicationContext().startActivity(intent);
                }
            });
