package com.example.aplikasipetugas.AdapterKesehatanImunisasiAnak;
...
import com.example.aplikasipetugas.Kesehatan_imunisasi_anak;
import com.example.aplikasipetugas.R;

import java.util.ArrayList;

public class AdaptorDataKesehatanImunisasiAnak extends BaseAdapter {
    public static String id;
    Context context;
    LayoutInflater inflater;
    ArrayList<GetKesehatanImunisasiAnak> model;

    public AdaptorDataKesehatanImunisasiAnak(Context context2, ArrayList<GetKesehatanImunisasiAnak> model2) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        view1 = this.inflater.inflate((int) R.layout.list_kesehatan_imunisasi_anak, (ViewGroup) null);
        if (view1 != null) {
            ...
            ((ImageView) view1.findViewById(R.id.tomboleksport)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(AdaptorDataKesehatanImunisasiAnak.this.context.getApplicationContext(), Kesehatan_imunisasi_anak.class);
                    intent.addFlags(268435456);
                    intent.putExtra("UploadTaskParameters.Companion.CodingKeys.id", AdaptorDataKesehatanImunisasiAnak.this.model.get(position).getId());
                    intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT|Intent.FLAG_ACTIVITY_NEW_TASK);
                    AdaptorDataKesehatanImunisasiAnak.this.context.getApplicationContext().startActivity(intent);
                }
            });
