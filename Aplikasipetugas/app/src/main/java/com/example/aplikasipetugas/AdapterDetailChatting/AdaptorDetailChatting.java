...
import com.example.aplikasipetugas.Halaman_Login;
...
public class AdaptorDetailChatting extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        View view1 = this.inflater.inflate(R.layout.list_chat, (ViewGroup) null);
        if (view1 != null) {
            ...
            if (Halaman_Login.nomorhp.equals(this.model.get(position).getNomor_hp_pengirim())) {
