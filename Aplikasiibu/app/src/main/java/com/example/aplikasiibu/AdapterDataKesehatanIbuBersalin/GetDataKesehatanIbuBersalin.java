...
public class GetDataKesehatanIbuBersalin {
    String agama_ayah = "";
    String agama_ibu = "";
    String alamat_rumah = "";
    ...
    String tempat_atau_tanggal_lahir_ayah = "";
    String tempat_atau_tanggal_lahir_ibu = "";

    public GetDataKesehatanIbuBersalin(int id2, String nama_ibu2, String nik2, String tempat_atau_tanggal_lahir_ibu2) {
        this.nama_ibu = nama_ibu2;
        this.nik = nik2;
        this.tempat_atau_tanggal_lahir_ibu = tempat_atau_tanggal_lahir_ibu2;
        this.kehamilan_ke = "";
        ...
        this.no_jkn_bpjs = "";
        this.nama_ayah = "";
        this.tempat_atau_tanggal_lahir_ayah = "";
        this.agama_ayah = "";
    ...
    public String getTempat_atau_tanggal_lahir_ibu() {
        return this.tempat_atau_tanggal_lahir_ibu;
    }
    ...
    public String getTempat_atau_tanggal_lahir_ayah() {
        return this.tempat_atau_tanggal_lahir_ayah;
    }
