...
public class AdaptorCatatanKesehatanIbuNifas extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) ImageView imageView = (ImageView) view1.findViewById(R.id.tomboleksport);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) ImageView tomboledit = (ImageView) view1.findViewById(R.id.tomboledit);
        View view12 = view1;
