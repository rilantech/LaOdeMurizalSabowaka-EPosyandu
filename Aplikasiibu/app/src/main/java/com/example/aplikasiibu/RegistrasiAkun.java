    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.panah_kembali.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                RegistrasiAkun.this.startActivity(new Intent(RegistrasiAkun.this.getApplicationContext(), HalamanLogin.class));
        ...
        this.btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (RegistrasiAkun.this.etNik.getText().toString().length() == 0) {
                    RegistrasiAkun.this.etNik.setError("Tidak Boleh Kosong");
                }
                ...
                Volley.newRequestQueue(RegistrasiAkun.this).add(new StringRequest(1, new Configurasi().baseUrl() + "api/registrasiaknibu", new Response.Listener<String>() {
                            ...
                            if (new JSONObject(response).getString(NotificationCompat.CATEGORY_STATUS).equals("berhasil")) {
                                ...
                                builder.setPositiveButton((CharSequence) "OK", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        RegistrasiAkun.this.startActivity(new Intent(RegistrasiAkun.this, HalamanLogin.class));
                                        RegistrasiAkun.this.finish();
                                    }
                                });
                                builder.create().show();
                    ...
                    public Map<String, String> getParams() throws AuthFailureError {
                        ...
                        myParams.put("nik_ibu", RegistrasiAkun.this.etNik.getText().toString());
